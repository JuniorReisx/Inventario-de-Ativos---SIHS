...
const HeroSobre = () => {
  ...
  return (
    <div className="hero-sobre" ref={rootRef}>
      <section
        className={`hero-sobre__hero${ready ? ' is-ready' : ''}`}
        aria-label="Sobre"
      >
        <canvas
          ref={canvasRef}
          id="hero-canvas-sobre"
          className="hero-sobre__canvas"
          aria-hidden="true"
        />
        <div className="hero-sobre__scrim" aria-hidden="true" />
        <div className="hero-sobre__sweep" aria-hidden="true" />
        <div className="hero-sobre__flow" aria-hidden="true" />

        <div className="hero-sobre__inner">
          <h1 className="hero-sobre__title">Sobre</h1>
          <span className="hero-sobre__accent" aria-hidden="true" />
          <p className="hero-sobre__subtitle">
